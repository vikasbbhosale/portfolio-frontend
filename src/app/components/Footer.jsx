...
//     {
//       name: 'GitHub',
//       url: 'https://github.com/vikasbbhosale',
//       icon: (
...
//     {
//       name: 'LinkedIn',
//       url: 'https://www.linkedin.com/in/vikas-bhosale-749aa4318/',
//       icon: (
...
//     {
//       name: 'Twitter',
//       url: 'https://x.com/VikasBhosale123',
//       icon: (
...
//     {
//       name: 'Instagram',
//       url: 'https://www.instagram.com/_vikas_7275/',
//       icon: (
...
//           © {new Date().getFullYear()} Vikas Bhosale. All rights reserved.
//         </p>
//       </div>
//     </footer>
//   );
 ...
 const socialLinks = [
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-bottom">
        <p className="copyright">
          &copy; {new Date().getFullYear()} Vikas Bhosale. All rights reserved.
        </p>
      </div>
    </footer>
  );
